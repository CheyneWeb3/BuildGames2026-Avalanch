...
import { registerDiceCoreRoutes } from '@hauscashier/module-dice';
import { registerLotteryCoreRoutes } from '@hauscashier/module-lottery';
import { registerWhackCoreRoutes } from '@hauscashier/module-whack';
